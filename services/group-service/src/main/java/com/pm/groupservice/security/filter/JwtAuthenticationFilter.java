package com.pm.groupservice.security.filter;

import com.pm.groupservice.security.JwtTokenValidator;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (StringUtils.hasText(gatewayUserId)) {
            // Context passed directly from API Gateway headers
            try {
            ...
            // Direct JWT token validation fallback
